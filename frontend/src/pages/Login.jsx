...
export default function Login() {
  ...
  return (
    <div className="max-w-sm mx-auto px-4 sm:px-6 py-20">
      ...
      <h1 className="font-display font-700 text-2xl text-center mb-1">Welcome back</h1>
      <p className="text-center text-sm text-mute mb-8">Good to see you again — let's find your next listen.</p>
